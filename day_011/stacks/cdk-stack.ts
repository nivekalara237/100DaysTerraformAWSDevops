...
import { WebsiteDistributeionProps, WebsiteDistribution } from './constructs/website-distribution.construct'
...
export class CdkStack extends BaseStack {
  constructor(scope: Construct, id: string, private props: CustomStackProps) {
    ...
    const cognitoUserPool = new Cognito(this, 'CustomCognitoResource', {
      verificationEmailUrl: `${props.distribution?.domainName}/auth/confirm-email`,
    ...
    new ApiDomainName(this, 'TodoListApiDomainName', {
      ...
      api: restApi,
      certificateArn: props.acm?.certificateArn!
    })
