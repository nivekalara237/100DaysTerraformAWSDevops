...
export class LambdaFunction extends cdk.Construct {
  ...
  grantInvoke = (grantable: IGrantable, sourceArn: string, sourceAccount?: string) => {
    this._resource.addPermission(`LambdaGrantInvokePermission_${generateResourceID()}`, {
      action: 'lambda:InvokeFunction',
      principal: grantable.grantPrincipal,
      sourceArn,
