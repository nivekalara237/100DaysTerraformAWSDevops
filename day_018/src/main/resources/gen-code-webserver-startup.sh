...
git clone --branch day18/producer-and-consumers https://github.com/nivekalara237/100DaysTerraformAWSDevops.git
# shellcheck disable=SC2164
cd 100DaysTerraformAWSDevops/apps/ms-gen-code
